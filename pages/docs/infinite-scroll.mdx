...
<PropList types={[
  ...
  },
  {
    name: 'loadFunction',
    type: 'function',
    description: 'Function to load pages'
  },
  {
    name: 'pageLimit',
    default: '',
    type: 'string | number',
    description: 'The total number of pages the infinite scroll opens'
  },
  {
    name: 'children',
    type: 'function',
    description: 'Callback function that maps items to be in the infinite scroll',
    required: true
  },
]} />
